...
public class PreferenceHandler {
	...
	public float getAvgPoints() {
		...
		float defaultValue = Float.parseFloat(context.getResources().getString(R.string.avgPoints_default));
	...
	public Boolean getIsOkay() {
		...
		Boolean defaultValue = Boolean.valueOf(context.getResources().getString(R.string.isOkay_default));
